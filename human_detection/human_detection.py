...
class ObjectDetect:
    ...
    def Scan(self, threshold=0.5, show_output=True, resolution="1280x720"):
            ...
            while True:
                ...
                for i in range(len(scores)):
                    if ((scores[i] > threshold) and (scores[i] <= 1.0)):
                        ...
                        if (xcenter >= mid_x - 64 and xcenter < mid_x + 64) and (ycenter >= mid_y - 64 and ycenter < mid_y + 64):
                            location = "center"
                        elif xcenter <= mid_x:
                            location = "left"
                        else:
...
if __name__=="__main__":
    test = ObjectDetect(model_dir="model.tflite")
    test.Scan()